...
import 'package:machinetask/utils/Text_const.dart';
...
class _HomeViewState extends State<HomeView> {
  @override
  void initState() {
    Provider.of<WeatherService>(context, listen: false).getUserLocation();
  ...
  Widget build(BuildContext context) {
    var controller = Provider.of<WeatherService>(context, listen: false);
    return Scaffold(
      appBar: AppBar(
        actions: [
          Padding(
